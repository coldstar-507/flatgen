...
func (t *MessageEventT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	roomOffset := flatbuffers.UOffsetT(0)
	if t.Room != "" {
		roomOffset = builder.CreateString(t.Room)
	}
	...
	MessageEventAddRoom(builder, roomOffset)
	...
	MessageEventAddSenderId(builder, t.SenderId)
	MessageEventAddTimestamp(builder, t.Timestamp)
	MessageEventAddForwardedFrom(builder, t.ForwardedFrom)
...
func (rcv *MessageEvent) Room() []byte {
...
func (rcv *MessageEvent) Nodes(j int) uint64 {
...
func (rcv *MessageEvent) MutateNodes(j int, n uint64) bool {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(16))
	if o != 0 {
		a := rcv._tab.Vector(o)
...
func (rcv *MessageEvent) SenderId() uint64 {
...
func (rcv *MessageEvent) MutateSenderId(n uint64) bool {
...
func (rcv *MessageEvent) ForwardedFrom() uint64 {
...
func (rcv *MessageEvent) MutateForwardedFrom(n uint64) bool {
...
func MessageEventAddSenderTag(builder *flatbuffers.Builder, senderTag flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(senderTag), 0)
}
...
func MessageEventAddRoom(builder *flatbuffers.Builder, room flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(room), 0)
}
func MessageEventAddForwardedFromTag(builder *flatbuffers.Builder, forwardedFromTag flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(forwardedFromTag), 0)
}
...
func MessageEventAddReplies(builder *flatbuffers.Builder, replies flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(replies), 0)
}
...
func MessageEventAddTxt(builder *flatbuffers.Builder, txt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(txt), 0)
}
func MessageEventAddMediaRef(builder *flatbuffers.Builder, mediaRef flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(mediaRef), 0)
}
func MessageEventAddPaymentRef(builder *flatbuffers.Builder, paymentRef flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(paymentRef), 0)
}
func MessageEventAddEmoji(builder *flatbuffers.Builder, emoji flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(emoji), 0)
}
func MessageEventAddSniper(builder *flatbuffers.Builder, sniper flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(sniper), 0)
}
func MessageEventAddSenderId(builder *flatbuffers.Builder, senderId uint64) {
	builder.PrependUint64Slot(13, senderId, 0)
}
func MessageEventAddTimestamp(builder *flatbuffers.Builder, timestamp int64) {
	builder.PrependInt64Slot(14, timestamp, 0)
}
func MessageEventAddForwardedFrom(builder *flatbuffers.Builder, forwardedFrom uint64) {
	builder.PrependUint64Slot(15, forwardedFrom, 0)
}
