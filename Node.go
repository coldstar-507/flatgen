...
func (t *NodeT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	NodeAddIsPrivate(builder, t.IsPrivate)
...
func (rcv *Node) MutateIsPrivate(n bool) bool {
...
func NodeAddIsPrivate(builder *flatbuffers.Builder, isPrivate bool) {
	builder.PrependBoolSlot(11, isPrivate, false)
}
